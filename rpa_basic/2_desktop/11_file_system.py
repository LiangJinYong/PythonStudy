...
# 파일 경로에서 폴더 정보 가져오기
# print(os.path.dirname(r"D:\PythonWorkspace\Freedom\my_file.txt"))
...
# 주어진 경로가 파일인지? 폴더인지?
# print(os.path.isdir("rpa_basic")) # rpa_basic 은 폴더인가?
# print(os.path.isfile("rpa_basic")) # rpa_basic 은 파일인가?

# print(os.path.isdir("plus_icon.png"))
# print(os.path.isfile("plus_icon.png"))

# 만약에 지정된 경로에 해당하는 파일 / 폴더가 없다면?
# print(os.path.isdir("plus_iconnnnn.png"))

# 주어진 경로가 존재하는지?
# if os.path.exists("plus_icons.png"):
...
# 파일명 변경하기
# os.rename("new_file.txt", "new_file_rename.txt") # new_file.txt -> new_file_rename 로 이름 변경
...
# 파일 복사하기
# 어떤 파일을 폴더 안으로 복사하기
# shutil.copy("plus_icon.png", "test_folder") # 원본 파일 경로, 대상 폴더 경로
# 어떤 파일을 폴더 안에 새로운 파일 이름으로 복사하기
# shutil.copy("plus_icon.png", "test_folder/copied_plus_icon.png") # 원본 파일 경로, 대상 경로(변경된 파일명까지)

# shutil.copyfile("plus_icon.png", "test_folder/copied_plus_icon_2.png") # 원본 파일 경로, 대상 파일 경로

# shutil.copy("plus_icon.png", "test_folder/copy.png")
# shutil.copy2("plus_icon.png", "test_folder/copy2.png") # 원본 파일 경로, 대상 폴더(파일) 경로
...
shutil.move("test_folder", "test_folder_rename") # 폴더명 병경되는 효과